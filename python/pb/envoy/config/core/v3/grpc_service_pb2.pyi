...
class GrpcService(google.protobuf.message.Message):
    ...
    class EnvoyGrpc(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["authority", b"authority", "cluster_name", b"cluster_name"]) -> None: ...
    ...
    class GoogleGrpc(google.protobuf.message.Message):
        ...
        class SslCredentials(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing_extensions.Literal["cert_chain", b"cert_chain", "private_key", b"private_key", "root_certs", b"root_certs"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing_extensions.Literal["cert_chain", b"cert_chain", "private_key", b"private_key", "root_certs", b"root_certs"]) -> None: ...
        ...
        class ChannelCredentials(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing_extensions.Literal["credential_specifier", b"credential_specifier", "google_default", b"google_default", "local_credentials", b"local_credentials", "ssl_credentials", b"ssl_credentials"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing_extensions.Literal["credential_specifier", b"credential_specifier", "google_default", b"google_default", "local_credentials", b"local_credentials", "ssl_credentials", b"ssl_credentials"]) -> None: ...
            def WhichOneof(self, oneof_group: typing_extensions.Literal["credential_specifier", b"credential_specifier"]) -> typing_extensions.Literal["ssl_credentials", "google_default", "local_credentials"] | None: ...
        ...
        class CallCredentials(google.protobuf.message.Message):
            ...
            class ServiceAccountJWTAccessCredentials(google.protobuf.message.Message):
                ...
                def ClearField(self, field_name: typing_extensions.Literal["json_key", b"json_key", "token_lifetime_seconds", b"token_lifetime_seconds"]) -> None: ...
            ...
            class GoogleIAMCredentials(google.protobuf.message.Message):
                ...
                def ClearField(self, field_name: typing_extensions.Literal["authority_selector", b"authority_selector", "authorization_token", b"authorization_token"]) -> None: ...
            ...
            def HasField(self, field_name: typing_extensions.Literal["access_token", b"access_token", "credential_specifier", b"credential_specifier", "from_plugin", b"from_plugin", "google_compute_engine", b"google_compute_engine", "google_iam", b"google_iam", "google_refresh_token", b"google_refresh_token", "service_account_jwt_access", b"service_account_jwt_access", "sts_service", b"sts_service"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing_extensions.Literal["access_token", b"access_token", "credential_specifier", b"credential_specifier", "from_plugin", b"from_plugin", "google_compute_engine", b"google_compute_engine", "google_iam", b"google_iam", "google_refresh_token", b"google_refresh_token", "service_account_jwt_access", b"service_account_jwt_access", "sts_service", b"sts_service"]) -> None: ...
            def WhichOneof(self, oneof_group: typing_extensions.Literal["credential_specifier", b"credential_specifier"]) -> typing_extensions.Literal["access_token", "google_compute_engine", "google_refresh_token", "service_account_jwt_access", "google_iam", "from_plugin", "sts_service"] | None: ...
        ...
        class ChannelArgs(google.protobuf.message.Message):
            ...
            class Value(google.protobuf.message.Message):
                ...
                def HasField(self, field_name: typing_extensions.Literal["int_value", b"int_value", "string_value", b"string_value", "value_specifier", b"value_specifier"]) -> builtins.bool: ...
                def ClearField(self, field_name: typing_extensions.Literal["int_value", b"int_value", "string_value", b"string_value", "value_specifier", b"value_specifier"]) -> None: ...
                def WhichOneof(self, oneof_group: typing_extensions.Literal["value_specifier", b"value_specifier"]) -> typing_extensions.Literal["string_value", "int_value"] | None: ...
        ...
        def HasField(self, field_name: typing_extensions.Literal["channel_args", b"channel_args", "channel_credentials", b"channel_credentials", "config", b"config", "per_stream_buffer_limit_bytes", b"per_stream_buffer_limit_bytes"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["call_credentials", b"call_credentials", "channel_args", b"channel_args", "channel_credentials", b"channel_credentials", "config", b"config", "credentials_factory_name", b"credentials_factory_name", "per_stream_buffer_limit_bytes", b"per_stream_buffer_limit_bytes", "stat_prefix", b"stat_prefix", "target_uri", b"target_uri"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["envoy_grpc", b"envoy_grpc", "google_grpc", b"google_grpc", "target_specifier", b"target_specifier", "timeout", b"timeout"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["envoy_grpc", b"envoy_grpc", "google_grpc", b"google_grpc", "initial_metadata", b"initial_metadata", "target_specifier", b"target_specifier", "timeout", b"timeout"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["target_specifier", b"target_specifier"]) -> typing_extensions.Literal["envoy_grpc", "google_grpc"] | None: ...
