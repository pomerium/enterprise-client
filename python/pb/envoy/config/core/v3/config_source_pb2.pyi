...
class _ApiVersionEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ApiVersion.ValueType], builtins.type):  # noqa: F821
...
class ApiConfigSource(google.protobuf.message.Message):
    ...
    class _ApiTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ApiConfigSource._ApiType.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class SelfConfigSource(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["transport_api_version", b"transport_api_version"]) -> None: ...
...
class RateLimitSettings(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["fill_rate", b"fill_rate", "max_tokens", b"max_tokens"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["fill_rate", b"fill_rate", "max_tokens", b"max_tokens"]) -> None: ...
...
class PathConfigSource(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["watched_directory", b"watched_directory"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["path", b"path", "watched_directory", b"watched_directory"]) -> None: ...
...
class ConfigSource(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["ads", b"ads", "api_config_source", b"api_config_source", "config_source_specifier", b"config_source_specifier", "initial_fetch_timeout", b"initial_fetch_timeout", "path", b"path", "path_config_source", b"path_config_source", "self", b"self"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["ads", b"ads", "api_config_source", b"api_config_source", "authorities", b"authorities", "config_source_specifier", b"config_source_specifier", "initial_fetch_timeout", b"initial_fetch_timeout", "path", b"path", "path_config_source", b"path_config_source", "resource_api_version", b"resource_api_version", "self", b"self"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["config_source_specifier", b"config_source_specifier"]) -> typing_extensions.Literal["path", "path_config_source", "api_config_source", "ads", "self"] | None: ...
...
class ExtensionConfigSource(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["config_source", b"config_source", "default_config", b"default_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["apply_default_config_without_warming", b"apply_default_config_without_warming", "config_source", b"config_source", "default_config", b"default_config", "type_urls", b"type_urls"]) -> None: ...
