...
class Pipe(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["mode", b"mode", "path", b"path"]) -> None: ...
...
class EnvoyInternalAddress(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["address_name_specifier", b"address_name_specifier", "server_listener_name", b"server_listener_name"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["address_name_specifier", b"address_name_specifier", "endpoint_id", b"endpoint_id", "server_listener_name", b"server_listener_name"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["address_name_specifier", b"address_name_specifier"]) -> typing_extensions.Literal["server_listener_name"] | None: ...
...
class SocketAddress(google.protobuf.message.Message):
    ...
    class _ProtocolEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[SocketAddress._Protocol.ValueType], builtins.type):  # noqa: F821
    ...
    def HasField(self, field_name: typing_extensions.Literal["named_port", b"named_port", "port_specifier", b"port_specifier", "port_value", b"port_value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["address", b"address", "ipv4_compat", b"ipv4_compat", "named_port", b"named_port", "port_specifier", b"port_specifier", "port_value", b"port_value", "protocol", b"protocol", "resolver_name", b"resolver_name"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["port_specifier", b"port_specifier"]) -> typing_extensions.Literal["port_value", "named_port"] | None: ...
...
class TcpKeepalive(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["keepalive_interval", b"keepalive_interval", "keepalive_probes", b"keepalive_probes", "keepalive_time", b"keepalive_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["keepalive_interval", b"keepalive_interval", "keepalive_probes", b"keepalive_probes", "keepalive_time", b"keepalive_time"]) -> None: ...
...
class BindConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["freebind", b"freebind", "source_address", b"source_address"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["additional_source_addresses", b"additional_source_addresses", "freebind", b"freebind", "socket_options", b"socket_options", "source_address", b"source_address"]) -> None: ...
...
class Address(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["address", b"address", "envoy_internal_address", b"envoy_internal_address", "pipe", b"pipe", "socket_address", b"socket_address"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["address", b"address", "envoy_internal_address", b"envoy_internal_address", "pipe", b"pipe", "socket_address", b"socket_address"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["address", b"address"]) -> typing_extensions.Literal["socket_address", "pipe", "envoy_internal_address"] | None: ...
...
class CidrRange(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["prefix_len", b"prefix_len"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["address_prefix", b"address_prefix", "prefix_len", b"prefix_len"]) -> None: ...
