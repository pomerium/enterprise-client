...
class AccessLog(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["config_type", b"config_type", "filter", b"filter", "typed_config", b"typed_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["config_type", b"config_type", "filter", b"filter", "name", b"name", "typed_config", b"typed_config"]) -> None: ...
...
class ComparisonFilter(google.protobuf.message.Message):
    ...
    class _OpEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ComparisonFilter._Op.ValueType], builtins.type):  # noqa: F821
    ...
    def ClearField(self, field_name: typing_extensions.Literal["op", b"op", "value", b"value"]) -> None: ...
...
class RuntimeFilter(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["percent_sampled", b"percent_sampled"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["percent_sampled", b"percent_sampled", "runtime_key", b"runtime_key", "use_independent_randomness", b"use_independent_randomness"]) -> None: ...
...
class GrpcStatusFilter(google.protobuf.message.Message):
    ...
    class _StatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[GrpcStatusFilter._Status.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    def ClearField(self, field_name: typing_extensions.Literal["exclude", b"exclude", "statuses", b"statuses"]) -> None: ...
...
class MetadataFilter(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["match_if_key_not_found", b"match_if_key_not_found", "matcher", b"matcher"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["match_if_key_not_found", b"match_if_key_not_found", "matcher", b"matcher"]) -> None: ...
