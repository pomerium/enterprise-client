...
class MetadataKind(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["cluster", b"cluster", "host", b"host", "kind", b"kind", "request", b"request", "route", b"route"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cluster", b"cluster", "host", b"host", "kind", b"kind", "request", b"request", "route", b"route"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["kind", b"kind"]) -> typing_extensions.Literal["request", "route", "cluster", "host"] | None: ...
